...
profiles = ['nowness','zhaomingwuartist','vgiarrano','zinlimart','seancheetham','drawingcenter','milohartnoll','art','artbasel','laafa','igorlipskykh','contemporary.paintings','jvan_rviz','contemporaryfigurativeart','piddy1972','stephenbaumanartwork','polina_abdulaeva_art','philhalestudio','jlou.is','alan_mcgowan_art','stefan_froehlich','thefilmmagazine','nibera_35mm','neilkrug','evazubeck','23h46min','retronyc','f1rstoftheroll','analogue_people','filmphotomag','thomhavlik','magazine35mm','in.film.we.trust','prianalog','film.wave','shootfilmmag']
